...
client.on('message', message => {
    ...
    if (message.content === '*help') {
        let embed = new Discord.RichEmbed()
            .setThumbnail(message.author.avatarURL)
            .addField("** مبرمج البوت :wrench: **", "**@!ZinoSD*[DC]#6067**")
            .setColor('RANDOM')
        message.author.sendEmbed(embed);
    }
});
...
client.on('ready', () => {
    console.log(`----------------`);
    console.log(`AG BOT- Script By : ZinoDzYT`);
    console.log(`----------------`);
    console.log(`ON ${client.guilds.size} Servers '     Script By : ZinoDzYT ' `);
    console.log(`----------------`);
    console.log(`Logged in as ${client.user.tag}!`);
    client.user.setGame(` AG  ${client.guilds.size} WITH ZinoDzYT *help`, "https://www.twitch.tv/zinodz05")
...
client.login("NDUyMzY4MzU1NzE0OTI0NTQ0.Dfjbjg.P4xhleUAXzA6Y_aw4CVdKk5UX6Y");                                                                                                                                                                                                                 